/**
 * @license capacitor.js 0.4.0 Copyright (c) 2014, Mikkel Schmidt. All Rights Reserved.
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Immutable, ListStore, Store, _, invariant,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Immutable, IndexedListStore, Store, _, invariant,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	module.exports = IndexedListStore = (function(superClass) {
	  ...
	  IndexedListStore.prototype.add = function(index, ids) {
	    ...
	    invariant(_.isNumber(ids) || _.isString(ids) || _.isArray(ids), "IndexedListStore.add(...): Second parameter should be a number/string (id) or an array of numbers/strings (ids).");
	    if (!_.isArray(ids)) {
	      ids = [ids];
	    }
	  ...
	  IndexedListStore.prototype.getIds = function(index) {
	    var ref;
	    return (ref = this.get('map').get(index)) != null ? ref : Immutable.List([]);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function() {
	  var EventBroker, _immediateListeners, _listeners, shouldTrigger;
	  _listeners = [];
	  _immediateListeners = [];
	  shouldTrigger = false;
	  ...
	  EventBroker.dispatchImmediate = function() {
	    var args, i, len, listener, results;
	    args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
	    results = [];
	    for (i = 0, len = _immediateListeners.length; i < len; i++) {
	      listener = _immediateListeners[i];
	      results.push(listener.fn.apply(listener, args));
	    }
	    return results;
	  };
